...
/**
 * Script to fix payment 1272: change direction from 'in' to 'out' and assign to "Возвраты клиентам" expense category
 */
...
async function main() {
  console.log('🔧 Fixing payment 1272: changing to expense with "Возвраты клиентам" category...\n');
  ...
  try {
    ...
    console.log('✅ Payment 1272 fixed successfully');
