...
### Multi-page PDF handling (V1 decision)

- V1: обрабатывать **только 1-ю страницу** PDF для извлечения суммы/даты/вендора и **явно отображать** это в результате.
- V2: опционально — разрезать PDF на страницы и хранить как “один upload → несколько pages” с отдельными extraction.
